...
- [salesforcecli/plugin-data](https://github.com/salesforcecli/plugin-data) ([3.3.2](https://github.com/salesforcecli/plugin-data/releases/tag/3.3.2), today) - 
- [forcedotcom/SFDX-Data-Move-Utility](https://github.com/forcedotcom/SFDX-Data-Move-Utility) ([4.33.9](https://github.com/forcedotcom/SFDX-Data-Move-Utility/releases/tag/4.33.9), 1 day ago) - SFDMU is a cutting-edge Salesforce data migration tool for seamless org population from other orgs or CSV files. It handles all CRUD operations on multiple related objects in one go.
- [salesforcecli/plugin-deploy-retrieve](https://github.com/salesforcecli/plugin-deploy-retrieve) ([3.6.5](https://github.com/salesforcecli/plugin-deploy-retrieve/releases/tag/3.6.5), 1 day ago) - 
...
- [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) ([v1.28.0](https://github.com/R0Wi-DEV/workflow_ocr/releases/tag/v1.28.0), 4 months ago) - This is a Nextcloud Workflow App which enables you to process files via OCR on serverside.
...
- [Feature: set log level via settings UI](https://github.com/nextcloud/logreader/pull/1027) on [nextcloud/logreader](https://github.com/nextcloud/logreader) (6 months ago)

#### ⭐ Recent Stars

- [openhab/openhab-addons](https://github.com/openhab/openhab-addons) - Add-ons for openHAB (1 week ago)
