...
- [nextcloud/server](https://github.com/nextcloud/server) ([v32.0.2](https://github.com/nextcloud/server/releases/tag/v32.0.2), 3 days ago) - ☁️ Nextcloud server, a safe home for all your data
- [R0Wi-DEV/workflow_ocr_backend](https://github.com/R0Wi-DEV/workflow_ocr_backend) ([v1.32.1](https://github.com/R0Wi-DEV/workflow_ocr_backend/releases/tag/v1.32.1), 1 week ago) - Alternative backend for https://github.com/R0Wi-DEV/workflow_ocr
- [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) ([v1.31.3](https://github.com/R0Wi-DEV/workflow_ocr/releases/tag/v1.31.3), 1 month ago) - This is a Nextcloud Workflow App which enables you to process files via OCR on serverside.
...
- [fix: Use OCP\IAppConfig instead of OCP\IConfig to prevent config error](https://github.com/nextcloud/app_api/pull/713) on [nextcloud/app_api](https://github.com/nextcloud/app_api) (1 day ago)
...
- [[Backport stable32] Fix display files with special chars in path](https://github.com/nextcloud/files_photospheres/pull/168) on [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) (1 month ago)
- [[Backport stable31] Fix display files with special chars in path](https://github.com/nextcloud/files_photospheres/pull/167) on [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) (1 month ago)
- [Create stable32](https://github.com/nextcloud/files_photospheres/pull/166) on [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) (1 month ago)
