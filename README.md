...
- [forcedotcom/SFDX-Data-Move-Utility](https://github.com/forcedotcom/SFDX-Data-Move-Utility) ([4.32.5](https://github.com/forcedotcom/SFDX-Data-Move-Utility/releases/tag/4.32.5), today) - SFDMU is a cutting-edge Salesforce data migration tool for seamless org population from other orgs or CSV files. It handles all CRUD operations on multiple related objects in one go.
- [salesforcecli/plugin-deploy-retrieve](https://github.com/salesforcecli/plugin-deploy-retrieve) ([3.2.23](https://github.com/salesforcecli/plugin-deploy-retrieve/releases/tag/3.2.23), 1 day ago) - 
...
- [salesforcecli/plugin-data](https://github.com/salesforcecli/plugin-data) ([3.1.6](https://github.com/salesforcecli/plugin-data/releases/tag/3.1.6), 6 days ago) - 
...
- [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) ([v1.28.0](https://github.com/nextcloud/files_photospheres/releases/tag/v1.28.0), 2 months ago) - Nextcloud app for viewing Google PhotoSphere 360° images (panorama-images)
...
- [Update playwright.yml](https://github.com/nextcloud/files_photospheres/pull/138) on [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) (2 weeks ago)
...
- [[Backport stable27] Skip notifications when OCR mode is &#34;skip file&#34;](https://github.com/R0Wi-DEV/workflow_ocr/pull/234) on [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) (5 months ago)
