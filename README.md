...
- [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) - This is a Nextcloud Workflow App which enables you to process files via OCR on serverside. (6 days ago)
...
- [R0Wi-DEV/workflow_ocr_backend](https://github.com/R0Wi-DEV/workflow_ocr_backend) ([v1.31.0](https://github.com/R0Wi-DEV/workflow_ocr_backend/releases/tag/v1.31.0), 2 days ago) - Alternative backend for https://github.com/R0Wi-DEV/workflow_ocr
- [nextcloud/server](https://github.com/nextcloud/server) ([v31.0.0rc3](https://github.com/nextcloud/server/releases/tag/v31.0.0rc3), 3 days ago) - ☁️ Nextcloud server, a safe home for all your data
- [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) ([v1.31.0](https://github.com/nextcloud/files_photospheres/releases/tag/v1.31.0), 1 week ago) - Nextcloud app for viewing Google PhotoSphere 360° images (panorama-images)
- [R0Wi/nextcloud-appstore-push-action](https://github.com/R0Wi/nextcloud-appstore-push-action) ([v1.0.4](https://github.com/R0Wi/nextcloud-appstore-push-action/releases/tag/v1.0.4), 2 weeks ago) - Automatically publishes a new app version in the Nextcloud appstore after you created a new Github release
...
- [Add full integrationtests to pipeline](https://github.com/R0Wi-DEV/workflow_ocr/pull/294) on [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) (2 days ago)
- [Prep nc31](https://github.com/R0Wi-DEV/workflow_ocr/pull/292) on [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) (6 days ago)
- [Prep NC32](https://github.com/nextcloud/files_photospheres/pull/160) on [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) (1 week ago)
- [Prepare NC31](https://github.com/nextcloud/files_photospheres/pull/159) on [nextcloud/files_photospheres](https://github.com/nextcloud/files_photospheres) (1 week ago)
- [Update dependencies](https://github.com/R0Wi/nextcloud-appstore-push-action/pull/10) on [R0Wi/nextcloud-appstore-push-action](https://github.com/R0Wi/nextcloud-appstore-push-action) (2 weeks ago)
- [Merge changes from Nextcloud Fork](https://github.com/R0Wi/nextcloud-appstore-push-action/pull/9) on [R0Wi/nextcloud-appstore-push-action](https://github.com/R0Wi/nextcloud-appstore-push-action) (2 weeks ago)
- [fix: restrict mime type list depending on check operator](https://github.com/nextcloud/server/pull/50259) on [nextcloud/server](https://github.com/nextcloud/server) (3 weeks ago)
- [Implement Directory Check](https://github.com/nextcloud/server/pull/50258) on [nextcloud/server](https://github.com/nextcloud/server) (3 weeks ago)
- [Add support for workflow_ocr_backend](https://github.com/R0Wi-DEV/workflow_ocr/pull/291) on [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) (3 weeks ago)
- [Fix#273](https://github.com/R0Wi-DEV/workflow_ocr/pull/290) on [R0Wi-DEV/workflow_ocr](https://github.com/R0Wi-DEV/workflow_ocr) (3 weeks ago)
